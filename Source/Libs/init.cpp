...
sf::RenderWindow* initSFML_OpenGL(char* name, int AA, bool VSync) {
...
void loadShaders(std::vector<Shader> *shaderBuffer) {
  ...
  shader8.loadShader("Shader/reflection/vertex.c", "Shader/reflection/fragment.c");
...
void setup() {
    window = initSFML_OpenGL("3D-Engine", 16, true);
